...
3. Replace the remaining dylib bootstrap boundary inside `OwlBrowserCore` with an app-integrated browser runtime while keeping the current generated `OwlFreshSession`, pending-handle bind graph, and child-interface shape.

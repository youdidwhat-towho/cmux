...
3. Expand the Mojo schema from the current verifier surface toward real OWL concepts: session, profile, web view, renderer input, surface tree, and layer host/client.
